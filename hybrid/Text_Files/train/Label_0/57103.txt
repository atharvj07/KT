...
public class Main {
    ...
    static class ERandomPawn {
        ...
        public void solve(int testNumber, FastInput in, FastOutput out) {
            ...
            IntegerDequeImpl dq = new IntegerDequeImpl(n + 1);
            for (int i = 0; i <= n; i++) {
                while (dq.size() >= 2) {
                    int tail = dq.removeLast();
                    int tail2 = dq.peekLast();

                    if ((double) (heights[i] - heights[tail]) / (i - tail) < (double) (heights[tail] - heights[tail2]) / (tail - tail2)) {
                        dq.addLast(tail);
                        break;
                    }
                }
            ...
            debug.debug("convexHull", convexHull);
            ...
            for (int i = 0; i <= n; i++) {
                ...
                if (last == i) {
                    ...
                    y[i] = (double) (i - last) / (next - last) * (heights[next] - heights[last]) + heights[last];
                }
            }
