...
public class Main {
    ...
    static class FForkInTheRoad {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            Graph g = Graph.createGraph(n, s, t);
            ...
            double ans = Constants.LINF;
            for (int k = 0; k < n; k++) {
                int idx = -1;
                int cnt2 = 0;
                double value = -1;
                for (int l = g.firstOutbound(k); l != -1; l = g.nextOutbound(l)) {
                    int to = g.destination(l);
                    if (val[to] > value) {
                        idx = l;
                        value = val[to];
                    }
